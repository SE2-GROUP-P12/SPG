...
public class API {
    ...
    public static final String EXIST_CUSTOMER_BY_MAIL = "/customer/customerExistsByMail"; //can delete
    ...
    public static final String GET_ALL_ORDERS = "/customer/getAllOrders";
