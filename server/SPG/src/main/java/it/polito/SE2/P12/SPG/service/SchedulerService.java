...
public class SchedulerService {
    ...
    public SchedulerService() {
        ...
        addToSchedule(new MondayMorningSchedule(), LocalDate.now(applicationClock).with(TemporalAdjusters.next(DayOfWeek.MONDAY)).atTime(9, 0).toEpochSecond(ZoneOffset.ofHours(1)));
    }
        ...
        */
        ...
        do {
            ...
            if (e != null && e.getValue() <= applicationClock.instant().getEpochSecond()) {
                System.out.println(e.getClass().getName() + " executed");
                e.getKey().execute();
                schedule.remove(e);
            }
