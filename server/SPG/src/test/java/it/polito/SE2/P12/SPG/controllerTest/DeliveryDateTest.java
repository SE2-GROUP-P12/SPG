...
public class DeliveryDateTest {
    ...
    public void setDeliveryDateTest() throws Exception {
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post(API.HOME + API.DELIVERY_DATE)
                        ...
                        .content("{\"orderId\":" + orderId + ",\"deliveryDate\":\"1639740466\"}")
    ...
    @Test
    @WithUserDetails("tester@test.com")
    public void setDeliveryDateErrorTest() throws Exception {
        //Bad order ID
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post(API.HOME + API.DELIVERY_DATE)
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        //1639740466 is GMT: Friday 17 December 2021 11:27:46
                        // Your time zone: venerdì 17 dicembre 2021 12:27:46 GMT+01:00
                        .content("{\"orderId\":" + orderId+1000 + ",\"deliveryDate\":\"1639740466\"}")
                ).andExpect(status().isBadRequest())
                .andReturn();
        //Invalid json
        result = mockMvc.perform(MockMvcRequestBuilders.post(API.HOME + API.DELIVERY_DATE)
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        //1639740466 is GMT: Friday 17 December 2021 11:27:46
                        // Your time zone: venerdì 17 dicembre 2021 12:27:46 GMT+01:00
