...
public class BasketServiceTest {
    ...
    public void retrieveEmptyBasket() {
        User u = userRepo.findUserByEmail("custmer1@foomail.com");
        Basket b = basketRepo.findBasketByCust_UserId(u.getUserId());
    ...
    public void addCorrectlyProductToBasket(){
        ...
        User u1 = userRepo.findUserByEmail("cutstomer1@foomail.com");
        Basket b1 = basketRepo.findBasketByCust_UserId(u1.getUserId());
