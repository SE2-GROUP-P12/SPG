            ...
            <>
                <Card sx={{maxWidth: 345}}>
                    ...
                    {props.isLogged ? <CardActions>
                        <Grid container>
                            <Grid item xs={12}> <Button disabled={!sellTime} variant="success" onClick={handleShow}> Add
                                to cart </Button>
                            </Grid>
                        </Grid>
                    </CardActions> : <></>}
                                ...
                                >
                                    {({values, errors, touched}) =>
                                        <Form>
                                            ...
                                            <br/>
                                            <Button disabled={!sellTime} style={{margin: '20px'}} type="submit"
                                                    variant="success">Add to
                                                cart</Button>
